...
export const navBarConfig: NavBarConfig = {
  links: [
    ...
    {
      name: 'GitHub',
      url: 'https://github.com/sunrin-para/blog',     // Internal links should not include the base path, as it is automatically added
...
export const profileConfig: ProfileConfig = {
  ...
  name: 'PARA',
  bio: 'Project Achievement & Research Ai',
  links: [
    {
      name: 'Instagram',
      icon: 'fa6-brands:instagram',
      url: 'https://www.instagram.com/sunrin_para/',
    },
  ],
}
